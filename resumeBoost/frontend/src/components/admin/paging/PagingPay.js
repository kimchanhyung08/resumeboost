...
// pay paging 
const PagingPay = ({startPage, endPage, currentPage, totalPages, setPageData}) => {
  ...
  const pagingFn = async  (num) => {
    ...
    const res = await jwtAxios.get(`http://${EC2_URL}:8090/admin/pay?page=${realNum}`)
